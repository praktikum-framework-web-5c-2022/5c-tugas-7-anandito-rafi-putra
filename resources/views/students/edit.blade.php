            ...
            <div class="col-md-8">
               ...
               <form action="{{ route('student.update',['student' => $student->id]) }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="nis" placeholder="Input NIS" id="nis"  value="{{ old('nis')??$student->nis}}"
                        class="form-control">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        class="form-control" value="{{ old('nama')??$student->nama }}">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        value="{{ old('umur')??$student->umur}}" class="form-control">
                ...
                <div class="form-floating mb-3  ">
                    <select name="jurusan" placeholder="Input Jurusan" id="jurusan" class="form-select">
                        <option value="IPA" {{ old('jurusan')??$student->jurusan == "IPA" ? "selected" : "" }}>IPA</option>
                        <option value="IPS" {{ old('jurusan')??$student->jurusan == "IPS" ? "selected" : "" }}>IPS</option>
                    </select>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" name="eskul_id[]" id="{{ $eskul->id }}" value="{{ $eskul->id }}" {{ $student->eskuls()->find($eskul->id) ? 'checked' : '' }}>
